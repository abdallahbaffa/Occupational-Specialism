...
echo "<h2><u>Beautiful Colors Found in Nature</u></h2>";
echo "<p>In this page, I will be showing you pictures of nature with my favorite colors: </p>";
...
echo "<div class='image-caption'>";
echo "<p><i>Forest trail to that particular jungle.</i></p>";
echo "</div>";
echo "</div>";
...
echo "<div class='image-caption'>";
echo "<p><i>A relaxing purple underwater theme.</i></p>";
echo "</div>";
echo "</div>";
...
echo "<h3><i>Why is nature so colorful?</i></h3>";
