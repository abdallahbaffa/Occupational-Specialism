...
function new_console($conn, $post){
    try {
        $sql = "INSERT INTO console (manufacturer, console_name, release_date, controller_no, bit) VALUES(?, ?, ?, ?, ?)"; #Doing a prepared statementt, telling the database that the values would be sent badned independately. If this appraoch was not done, it would be easier to sql inject your things, which is really bad.
